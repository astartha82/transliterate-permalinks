...
$base = array(
  ...
  0x40 => 'H', 'Dz', 'Gh', 'Ch', 'M', 'Y', 'N', 'Sh', 'O', 'Ch', 'P', 'J', 'R', 'S', 'V', 'T',
  0x50 => 'R', 'C', 'U', 'P', 'Q', 'O', 'F', NULL, NULL, '<', '\'', '/', '!', ',', '?', '.',
  0x60 => NULL, 'a', 'b', 'g', 'd', 'e', 'z', 'e', 'e', 't', 'zh', 'i', 'l', 'kh', 'ts', 'k',
  0x70 => 'h', 'dz', 'gh', 'ch', 'm', 'y', 'n', 'sh', 'o', 'ch', 'p', 'j', 'r', 's', 'v', 't',
  0x80 => 'r', 'c', 'u', 'p', 'q', 'o', 'f', 'ev', NULL, '.', '-', NULL, NULL, NULL, NULL, NULL,
  0x90 => NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
  0xA0 => '', '', NULL, '', '', '', '', '', '', '', '', '', '', '', '', '',
